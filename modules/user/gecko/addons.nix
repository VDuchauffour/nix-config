{
  ...
  # Checkmarks
  "{bd97f89b-17ba-4539-9fec-06852d07f917}" = {
    install_url = "https://addons.mozilla.org/firefox/downloads/latest/checkmarks-web-ext/latest.xpi";
    installation_mode = "force_installed";
  ...
  "{be8f6f90-2079-4e84-ac5c-13e6af2b48d1}" = {
    install_url = "https://addons.mozilla.org/firefox/downloads/latest/search-on-youtube-context-menu/latest.xpi";
    installation_mode = "force_installed";
    default_area = "menupanel";
    private_browsing = true;
  };
  ...
  "{d695a2bf-128b-485e-adec-08e5ae20b7e3}" = {
    install_url = "https://addons.mozilla.org/firefox/downloads/latest/space-bar-for-bandcamp/latest.xpi";
    installation_mode = "force_installed";
    default_area = "menupanel";
    private_browsing = true;
  };
